...
pub mod relax;
pub mod rheology;
use crate::prep::init_parameters;
use crate::relax::time_step;
use crate::rheology::lin_rheology;
use pyo3::prelude::*;
...
#[pymodule]
fn lp2r_lib(_py: Python, m: &PyModule) -> PyResult<()> {
    m.add_function(wrap_pyfunction!(lp2r,m)?)?;
    Ok(())
}
